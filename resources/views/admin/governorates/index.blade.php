    ...
    <div class="ibox box-primary">
        <div class="ibox-title">
            <div class="pull-right">
                ...
                <a href="{{url('admin/governorate/create')}}" class="btn btn-primary">
                    <i class="fa fa-plus"></i>  أضافة محافظة
                </a>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($records as $record)
                                ...
                                <td>{{optional($record)->name}}</td>
                                  <td class="text-center"><a href="{{url('admin/governorate/' . $record->id .'/edit')}}" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a></td></a></td>
                                 <td class="text-center">
                                    <button
                                    id="{{$record->id}}"
                                    data-token="{{ csrf_token() }}"
                                    data-route="{{url('admin/governorate/'.$record->id)}}"
                                    type="button"
